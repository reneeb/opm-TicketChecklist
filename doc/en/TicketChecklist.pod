...
L<http://feature-addons.de/otrs/Ticket%20Zoom/TicketChecklist> (even though
a some screenshots there are for the pro version).

=head1 SUPPORT

If you have any questions, ideas for new features, bugreports and/or patches,
please drop me a line at otrs@perl-services.de.
...
L<http://feature-addons.de/otrs/Ticket%20Zoom/TicketChecklist> that
...
=item * Support drag'n'drop

=item * Ticketeventmodule that allows one to automatically create checklists for tickets

=back

Those features will be released in the pro version first. If you want to sponsor one of those
features, please contact us at C<< <otrs@perl-services.de> >>.
...
fix bug: When public.pl was called, the outputfilter does not get a dbobject, hence an error in the backend module
